...
echo Html::a(\floor12\editmodal\IconHelper::PLUS . " " . Yii::t('app.f12.ecommerce', 'Create group'), null, [
    'onclick' => EditModalHelper::showForm('/shop/admin/discount-group/form', 0),
...
echo GridView::widget([
    ...
    'columns' => [
        ...
        ['contentOptions' => ['style' => 'min-width:100px; text-align:right;'],
            'content' => function (DiscountGroup $model) {
                return
                    Html::a(\floor12\editmodal\IconHelper::PENCIL, NULL, ['onclick' => EditModalHelper::showForm('/shop/admin/discount-group/form', $model->id), 'class' => 'btn btn-default btn-sm']) . " " .
                    Html::a(\floor12\editmodal\IconHelper::TRASH, NULL, ['onclick' => EditModalHelper::deleteItem('/shop/admin/discount-group/delete', $model->id), 'class' => 'btn btn-default btn-sm']);
            },
        ]
    ]
]);
