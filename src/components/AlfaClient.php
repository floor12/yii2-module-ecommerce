...
class AlfaClient
{
    ...
    const ENDPOINT_PREFIX = '/payment/rest/';
    ...
    public function __construct(array $options = [])
    {
        ...
        $this->endpointPrefix = $options['endpointPrefix'] ?? self::ENDPOINT_PREFIX;
    ...
    {
        return $this->doRegisterOrder($orderId, $amount, $returnUrl, $data, $this->endpointPrefix . '/register.do');
    }
    ...
    public function execute(string $action, array $data = []): array
    {
        ...
        if ($action[0] !== '/') {
            $action = $this->endpointPrefix . $action;
        }

        $rest = 0 === \strpos($action, $this->endpointPrefix);
    ...
    {
        return $this->doRegisterOrder($orderId, $amount, $returnUrl, $data, $this->endpointPrefix . 'registerPreAuth.do');
    }
    ...
    public function deposit($orderId, int $amount, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'deposit.do', $data);
    }
    ...
    public function reverseOrder($orderId, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'reverse.do', $data);
    }
    ...
    public function refundOrder($orderId, int $amount, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'refund.do', $data);
    }
    ...
    public function getOrderStatus($orderId, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'getOrderStatusExtended.do', $data);
    }
    ...
    public function verifyEnrollment(string $pan, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'verifyEnrollment.do', $data);
    }
    ...
    public function updateSSLCardList($orderId, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'updateSSLCardList.do', $data);
    }
    ...
    public function getLastOrdersForMerchants(\DateTimeInterface $from, \DateTimeInterface $to = null, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'getLastOrdersForMerchants.do', $data);
    }
    ...
    public function paymentOrderBinding($orderId, $bindingId, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'paymentOrderBinding.do', $data);
    }
    ...
    public function bindCard($bindingId, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'bindCard.do', $data);
    }
    ...
    public function unBindCard($bindingId, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'unBindCard.do', $data);
    }
    ...
    public function extendBinding($bindingId, \DateTimeInterface $newExpiry, array $data = []): array
    {
        ...
        return $this->execute($this->endpointPrefix . 'extendBinding.do', $data);
    }
    ...
    {
        return $this->execute($this->endpointPrefix . '/payment/rest/getReceiptStatus.do', $data);
    }
